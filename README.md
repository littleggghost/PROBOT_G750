...
This repository provides ROS support for PROBOT G750.   
...
$ git clone https://github.com/ps-micro/PROBOT_G750
```
...
1. Run PROBOT [install.sh](https://github.com/ps-micro/PROBOT_G750/install.sh)
```sh
...
```sh
$ roslaunch probot_bringup probot_g750_bringup.launch sim:=true
```

### __MoveIt! with real Hardware__  
There are launch files available to bringup a real robot(PROBOT G750).   
...
```sh
$ roslaunch probot_bringup probot_g750_bringup.launch robot_ip:=192.168.2.123
```
